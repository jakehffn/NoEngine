#include "sprite_outline_shader.hpp"

SpriteOutlineShader::SpriteOutlineShader() {
    
    std::string vertex_shader_path = "./src/systems/render/shaders/sprite_outline/src/vertexShader.glsl";
    std::string fragment_shader_path = "./src/systems/render/shaders/sprite_outline/src/fragmentShader.glsl";
...
void SpriteOutlineShader::renderSetup(glm::mat4 view, glm::mat4 projection, glm::vec2 atlas_dimensions) {
