...
SpriteShader::SpriteShader() {
    ...
    std::string vertexShaderPath = "./src/systems/render/shaders/sprite/vertexShader.glsl";
    std::string fragmentShaderPath = "./src/systems/render/shaders/sprite/fragmentShader.glsl";
