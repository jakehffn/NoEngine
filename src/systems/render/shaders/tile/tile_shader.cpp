...
TileShader::TileShader() {
    ...
    std::string vertexShaderPath = "./src/systems/render/shaders/tile/vertexShader.glsl";
    std::string fragmentShaderPath = "./src/systems/render/shaders/tile/fragmentShader.glsl";
