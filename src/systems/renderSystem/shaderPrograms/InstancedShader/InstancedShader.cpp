...
InstancedShader::InstancedShader() {
    ...
    std::string vertexShaderPath = "./src/systems/renderSystem/shaderPrograms/InstancedShader/vertexShader.glsl";
    std::string fragmentShaderPath = "./src/systems/renderSystem/shaderPrograms/InstancedShader/fragmentShader.glsl";
